    ...
    <div class="main_div">
        <table id="table">
            ...
            <tr>
                ...
                <td><?php echo $db_data4['customer_name']; ?></td>
                <td> <img src="../../images/<?php echo $db_data3['product_image']; ?>" alt="" style="width:50px; height: 100%; margin-left:25px;"></td>
                <td><?php echo $db_data3['product_name']; ?></td>
                <td><?php echo $db_data['order_quantity']; ?></td>
                <td><?php echo $total_price ?></td>
                <td><?php echo $db_data['payment_method']; ?></td>
                <td><?php echo $db_data4['address']; ?></td>
                <td> <a href="ordersdelete.php? order_id= <?php echo $order_id; ?>" title="Delete"><i class="fa-solid fa-trash" style="margin-left: 25px;"></i></a></td>
            </tr>
            <?php endwhile; ?>
            </tbody>
        </table>
